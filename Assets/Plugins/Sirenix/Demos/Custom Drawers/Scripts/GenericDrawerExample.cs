...
namespace Sirenix.OdinInspector.Demos
{
    ...
    {
        [OdinSerialize]
        public MyGenericClass<int, int> A = new();

        [OdinSerialize]
        public MyGenericClass<Vector3, Quaternion> B = new();

        [OdinSerialize]
        public MyGenericClass<int, GameObject> C = new();

        [OdinSerialize]
        public MyGenericClass<string, List<string>> D = new();

        [OdinSerialize]
        public MyGenericClass<string, string> E = new();

        public List<MyClass> F = new();
    }
