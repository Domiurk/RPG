...
namespace DevionGames
{
    public class ThirdPersonControllerSetupWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/Devion Games/Third Person Controller/Setup Character", false, 0)]
        ...
        private void OnGUI()
        {
            if(m_Character == null)
                EditorGUILayout
                    .HelpBox("Select the GameObject which will be used as the character. The required components will be added to it.",
                             MessageType.Error);
            ...
            if(m_AnimatorController == null || m_MaxFriction == null || m_Frictionless == null){
                if(GUILayout.Button("Init_Materials")){
                    m_AnimatorController =
                        AssetDatabase.LoadAssetAtPath<AnimatorController>
                            ($"{m_FolderPath}/Third Person Controller/Example/Animator Controllers/Third Person Controller.controller");
                    m_MaxFriction =
                        AssetDatabase.LoadAssetAtPath<PhysicMaterial>
                            ($"{m_FolderPath}/Third Person Controller/Example/Materials/MaxFriction.physicMaterial");
                    m_Frictionless =
                        AssetDatabase.LoadAssetAtPath<PhysicMaterial>
                            ($"{m_FolderPath}/Third Person Controller/Example/Materials/Frictionless.physicMaterial");
                }
            ...
            m_AnimatorController =
                (AnimatorController)EditorGUILayout.ObjectField("Animator Controller", m_AnimatorController,
            ...
            m_JumpAction = (InputActionReference)
                EditorGUILayout.ObjectField("Jump", m_JumpAction, typeof(InputActionReference), false);
            m_SprintAction = (InputActionReference)
                EditorGUILayout.ObjectField("Spring", m_SprintAction, typeof(InputActionReference), false);
            m_CrouchAction = (InputActionReference)
                EditorGUILayout.ObjectField("Crouch", m_CrouchAction, typeof(InputActionReference), false);
        ...
        private void SetupThirdPersonController()
        {
            ...
            changeHeight.InputAction = m_CrouchAction;
            ...
            changeSpeed.InputAction = m_JumpAction;
