...
namespace DevionGames.InventorySystem
{
	...
	public class Item : ScriptableObject, INameable, IJsonSerializable
	{
        ...
        public bool CanBuyBack => this.m_CanBuyBack;
		...
		public int SellPrice => Mathf.RoundToInt(this.m_SellPrice*Rarity.PriceMultiplier);
		...
		public GameObject OverridePrefab => this.m_OverridePrefab;
        ...
        public bool IsCraftable => this.m_IsCraftable;
        ...
        public float CraftingDuration => this.m_CraftingDuration;

        [Tooltip("Should a skill be used when item is crafted?")]
        [SerializeField]
        private bool m_UseCraftingSkill = false;

        public bool UseCraftingSkill => this.m_UseCraftingSkill;
        ...
        public string SkillWindow => this.m_SkillWindow;
        ...
        public Skill CraftingSkill => this.m_CraftingSkill;

        [Tooltip("Remove the ingredients when crafting fails.")]
        [SerializeField]
        private bool m_RemoveIngredientsWhenFailed = false;
        public bool RemoveIngredientsWhenFailed => this.m_RemoveIngredientsWhenFailed;
        ...
        public float MinCraftingSkillValue => this.m_MinCraftingSkillValue;
