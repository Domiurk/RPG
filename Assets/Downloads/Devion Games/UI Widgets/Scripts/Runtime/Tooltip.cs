...
namespace DevionGames.UIWidgets
{
    public class Tooltip : UIWidget
    {
        ...
        /// </summary>
        [Header("Behaviour")]
        [SerializeField] protected bool m_UpdatePosition = true;
        ...
        /// </summary>
        [SerializeField] protected StringPairSlot m_SlotPrefab;
                                 ...
                                 bool showBackground)
        {
            ...
            if(pairs is{ Count: > 0 }){
                foreach(StringPairSlot slotCache in m_SlotCache){
                    slotCache.gameObject.SetActive(false);
                }
        ...
        protected virtual StringPairSlot CreateSlot()
        {
            if(m_SlotPrefab != null){
                GameObject go = Instantiate(m_SlotPrefab.gameObject, m_SlotParent, false);
                go.SetActive(true);
